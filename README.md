...
2. По запросу программы ответьте на все вопросы
3. Программа выведет все операции, удовлетворяющие данным:
    дата операции, вид операции
    замаскированные данные карт и счетов для данной операции
    сумма операции в заданной валюте
...
Пользователь: да
Выберите слово, по которому производится сортировка: Открытие вклада
