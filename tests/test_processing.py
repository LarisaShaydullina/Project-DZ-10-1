...
def test_filter_by_state(filter_by_states_executed: str, filter_by_states_canceled: str,
                         filter_by_states_no: str, filter_by_states_any: str) -> None:
...
def test_sort_by_no_date(false_sort_by_no_date: str) -> None:
    dictionary_no_date = [
        {"id": 41428829, "state": "EXECUTED", "date": "2019-07-03T18:35:29.512364"},
        {"id": 939719570, "state": "EXECUTED", "date": "2018-06-30T02:08:58.425572"},
        {"id": 594226727, "state": "CANCELED", "date": "2018-09-12T21:27:25.241689"},
